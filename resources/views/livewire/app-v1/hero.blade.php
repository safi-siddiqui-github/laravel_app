        ...
        <div class="flex flex-col gap-4 md:gap-5 lg:gap-7">
            ...
            <div class="flex flex-wrap gap-2 lg:gap-4 tracking-tight">
                ...
                <button class="flex items-center gap-1 group">
                    <img src="{{asset('storage/icons/laravel.svg')}}" alt="laravel Icon" class="w-7 inline-block m-0.5 lg:group-hover:animate-bounce">
                    <span class="font-medium">Laravel</span>
                </button>

                <button class="flex items-center gap-1 group">
                    <img src="{{asset('storage/icons/tailwind.svg')}}" alt="tailwind Icon" class="w-7 inline-block m-0.5 lg:group-hover:animate-bounce">
                    <span class="font-medium">Tailwind</span>
                </button>

                <button class="flex items-center gap-1 group">
                    <img src="{{asset('storage/icons/livewire.svg')}}" alt="livewire Icon" class="w-7 inline-block m-0.5 lg:group-hover:animate-bounce">
            ...
            <div class="flex flex-col">
                ...
                <a href="https://github.com/safi-siddiqui-github/laravel_app" target="_blank" class="border hover:border-blue-500 rounded font-medium px-5 py-2 flex items-center justify-center gap-4">
                    ...
                    <img src="{{asset('storage/icons/new-tab.svg')}}" alt="New Page Icon" class="w-6 inline-block">
                </a>
            </div>
