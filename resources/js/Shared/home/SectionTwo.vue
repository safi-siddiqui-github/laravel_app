    ...
    <div class="p-5 md:p-10 gap-10 flex flex-col" id="section-one">
        ...
        <div class="grid grid-cols-4">
            ...
            <div class="flex flex-col border shadow rounded-xl p-5">
                <img src="storage/animated/message-animate.gif" alt="message-animate" class="object-contain">

                <a :href="$route('note.index')"
                    class="bg-gradient-to-r from-black to-blue-800 flex flex-col py-3 rounded-full items-center justify-center text-white">
